...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
  	<script src="<?=base_url()?>ckeditorbasic/ckeditor.js"></script>
...
<div class="divTableCell"><form action="<?=base_url()?>profil/galeri" method="post">                
              ...
              <button type="button" class="button special small" data-toggle="modal" data-target="#resimModal">Profil Resmi </button></a>
              <button type="button" class="button special small" data-toggle="modal" data-target="#myModal">Şifre Değiştir</button>
                ...
                <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                         <form name="myForm1"  onsubmit="return validateForm1()"  action="<?=base_url()?>profil/sifreguncelle/<?=$this->session->logged_in->Id?>" method="post">
                         <input type="password" name="esifre" placeholder="Eski şifre"><br>
                         <input type="password" name="ysifre" placeholder="Yeni şifre"><br>
                         <input type="password" name="y1sifre" placeholder="Yeni şifre-Tekrar"><br>
                          
                        
                    </div>
                    <div class="modal-footer">
                      <button type="submit" class="button special small" >Güncelle</button>
...
<!-- /.modal -->
 ...
 <div class="col-md-9">
     <div class="profile-content">
            ...
            <form name="myForm"  onsubmit="return validateForm()"  action="<?=base_url()?>profil/guncelle/<?=$this->session->logged_in->Id?>" method="post">
                            <div class="row uniform">
                            <div >
                            
                                <input size="80" type="text" name="adsoy" id="demo-name"  placeholder="Ad ve Soyad" value="<?=$profilbilgi[0]->adsoy?>" /><br>
                                <input type="email" name="email" id="demo-email"  placeholder="E-mail" value="<?=$profilbilgi[0]->email?>" /><br>
                                <input type="text" name="kullaniciadi" id="demo-name"  placeholder="Kullanıcı Adı" value="<?=$profilbilgi[0]->kullaniciadi?>" /><br>                         
                                <input type="text" name="dogumtarihi"   placeholder="Doğum Tarihi" value="<?=$profilbilgi[0]->dogumtarihi?>" /><br>
                                <input type="text" name="telefon" id="demo-name"  placeholder="Telefon" value="<?=$profilbilgi[0]->telefon?>" /><br>
                                <input type="text" name="meslek" id="demo-name"  placeholder="Meslek" value="<?=$profilbilgi[0]->meslek?>" /><br>
                                <textarea name="hakkinda" class="form-control" rows="3"><?=$profilbilgi[0]->hakkinda?></textarea>
                            ...
                            <input type="submit" class='button special ' name='next' value='Güncelle' />
                            </form>
...
<script>
  function validateForm() {
    ...
    var meslek = document.forms["myForm"]["meslek"].value;
...
<script>
  function validateForm1() {
    var eSifre = document.forms["myForm1"]["esifre"].value;
    var ySifre = document.forms["myForm1"]["ysifre"].value;
    var y1Sifre = document.forms["myForm1"]["y1sifre"].value;
    ...
    if (ySifre == "") {
      ...
      if (y1Sifre == "") {
       ...
       if (ysifre.length < 6) {
        alert("Şifreniz en az 6 karakter içermelidir !");
        return false;
    }
