										  ...
										  <div class="modal-dialog">
											...
											<div class="modal-content">
											  ...
											  <div class="modal-body">
												<form onsubmit="return validateForm()" id="myForm" action="<?=base_url()?>forum/saglikbaslikac" method="post" enctype="multipart/form-data">
												<h3>Konu Başlığı</h3>
											...
											<table class="alt">
												...
												?>
										         ...
										         ?>
													...
													<tr>
														<td><a href="<?=base_url()?>forum/saglikdetay/<?=$rs->Id?>"><?=$rs->baslik?></a><br><font size="1">Başlatan&nbsp;:&nbsp;
													...
													<?php 
															...
															<?php } ?>
																...
																if($this->session->logged_in) {
																	if($this->session->logged_in->Id==$rs->acanuyeId) { ?>
																	<a  href="<?=base_url()?>forum/saglikbasliksil/<?=$rs->Id?>" onclick="return confirm('Silmek İstediğinizden Eminmisiniz?');">
