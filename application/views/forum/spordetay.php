  ...
  <body>
    ...
    <!-- Wrapper -->
          ...
          <div id="main">
            <div class="inner">
                      ...
                      <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                          ...
                          <?php foreach ($davet as $rs) { ?>
                              ...
                              <a href="<?=base_url()?>forum/spordavet/<?=$fspor[0]->Id?>/<?=$rs->kimiId?>" onclick="return confirm('Davet göndermek istediğinizden emin misiniz?');"><li><?=$rs->kimiad?>&emsp;</li></a>
              ...
              <?php
                ...
                foreach((array)$fsporyorum as $rs)
                {
                    ...
                    <div class="panel panel-white post panel-shadow">
                      ...
                      <div class="post-description kk"> 
                        ...
                        <?php if($rs->img)  {    ?>
                         ...
                         <img  src="<?=base_url()?>uploads/<?=$rs->img;?>">
            ...
            </div><font color="#F56A6A"><p align="right"><a href="<?=base_url()?>forum/sporpaylasimsil/<?=$rs->Id?>/<?=$spordonId?>" onclick="return confirm('Silmek İstediğinizden Eminmisiniz?');">

                      <?php 
                        if($this->session->logged_in)
                            {
                              if($this->session->logged_in->Id==$rs->uye_ID) { ?>
                      <form action="<?=base_url()?>forum/sporpaylasimsil/<?=$rs->Id?>" method="post">
      ...
      <div class="row">
                ...
                foreach($fspor as $rs)
                {               
                ?>  <form onsubmit="return validateForm()" id="myForm"  action="<?=base_url()?>forum/sporyorumkaydet/<?=$rs->Id?>" method="POST"> <?php } ?>
                ...
                foreach($fspor as $rs)
                {               
                ?> <form onsubmit="return validateForm1()" id="myForm1"  action="<?=base_url()?>forum/sporyorumresimkaydet/<?=$rs->Id?>" method="post" enctype="multipart/form-data"><?php } ?>
