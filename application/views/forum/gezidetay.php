					...
					<div id="main">
						<div class="inner">
										    ...
										    <div class="modal-content">
										      ...
										      <div class="modal-body">
													...
													<?php foreach ($davet as $rs) { ?>
											  			...
											  			<a href="<?=base_url()?>forum/gezidavet/<?=$fgezi[0]->Id?>/<?=$rs->kimiId?>" onclick="return confirm('Davet göndermek istediğinizden emin misiniz?');"><li><?=$rs->kimiad?>&emsp;</li></a>
							...
							<?php
								...
								foreach((array)$fgeziyorum as $rs)
								{
						...
						</div><font color="#F56A6A"><p align="right"><a href="<?=base_url()?>forum/gezipaylasimsil/<?=$rs->Id?>/<?=$gezidonId?>" onclick="return confirm('Silmek İstediğinizden Eminmisiniz?');">
                        ...
                        <div class="panel-body">
                            <div class="panel-group" id="accordion">
                             ...
                             <?php
								foreach($fgezi as $rs)
								{								
								?>  <form onsubmit="return validateForm()" id="myForm"  action="<?=base_url()?>forum/geziyorumkaydet/<?=$rs->Id?>" method="POST"> <?php } ?>
								...
								foreach($fgezi as $rs)
								{								
								?> <form onsubmit="return validateForm1()" id="myForm1"  action="<?=base_url()?>forum/geziyorumresimkaydet/<?=$rs->Id?>" method="post" enctype="multipart/form-data"><?php } ?>
