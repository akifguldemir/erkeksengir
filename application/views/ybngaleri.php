                      ...
                      <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                          <div class="modal-header">
                            ...
                            <form  action="<?=base_url()?>profil/ybngaleriyorumkaydet/<?=$rs->Id?>" method="post">                           
                            ...
                            <input type="hidden" name="kimeId" value="<?=$profilbilgi[0]->Id?>">
                              ...
                              <li>          
                                 <div style="background-color: #F5F6F7; width: 550px; height:60px; ">
                                     ...
                                     <br>&emsp;<font color="black" size="2"><?=$row->yorum?></font><font size="1"><div style="float: right;"><?=$row->tarih?>  <?php 
                                       if($row->uye_ID==$this->session->logged_in->Id) { ?>
                                                
                                                <a href="<?=base_url()?>profil/galeriyorumsil2/<?=$row->Id?>/<?=$profilbilgi[0]->Id?>" onclick="return confirm('Yorumu silmek istediğinizden emin misiniz?');" class="paylasimyorumsil"><i class="glyphicon glyphicon-trash"></i></a>
                                        <?php } ?></div></font></font>
                                 </div>            
                              </li>
