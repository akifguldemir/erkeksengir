        ...
        <div class="panel panel-white post panel-shadow">
            <div class="post-heading">
                <div class="pull-left image">
                    <img src="<?=base_url()?>uploads/<?=$galeri[0]->sahipimg?>" class="img-circle avatar" alt="user profile image">
                </div>
                <div class="pull-left meta">
                    <div class="title h5">
                        <a href="#"><b><?=$galeri[0]->adsoy?></b></a>
                        paylaştı.
                        </div>
                    <h6 class="text-muted time"><?=$galeri[0]->tarih?></h6>
                </div>
            </div> 
            <div class="post-description "> 
                            
                    <div class="thumbnail">
                    <a href="<?=base_url()?>uploads/<?=$galeri[0]->img;?>" target="_blank">
                      <img  src="<?=base_url()?>uploads/<?=$galeri[0]->img;?>" alt="Lights" style="width:300px;">
            ...
            <div class="post-footer">
                <div class="input-group"> 
                             ...
                             <form action="<?=base_url()?>profil/ybngaleriyorumkaydet1/<?=$galeri[0]->Id?>/<?=$donId?>" method="post">
                                   <input type="hidden" name="kimeId" value="<?=$galeri[0]->uye_ID?>">                                   
                  ...
                  <div class="panel panel-default">
                    <div class="panel-heading">
                      <h4 class="panel-title">
                        <a data-toggle="collapse" href="#collapse1">Yorumlar</a>
                      </h4>
                    </div>
                    <div id="collapse1" class="panel-collapse collapse">
                      <div class="panel-body"><?php foreach ($galeriyorum as $row) { ?>
                                  ...
                                  <li class="comment">
                                    ...
                                    <div class="comment-body">
                                      <div class="comment-heading">
                                        <h4 class="user"><?=$row->uye_adsoy?></h4>
                                        <h5 class="time"><?=$row->tarih?></h5>
                                        <div class="sss">
                                        

                                        <form action="<?=base_url()?>profil/fotoyorumsil1/<?=$row->Id?>/<?=$donId?>" method="post">
                                         <input type="hidden" name="don" value="<?=$row->fotoId?>" >
