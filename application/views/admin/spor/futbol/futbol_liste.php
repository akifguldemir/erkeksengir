...
?>
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Futbol Liste</h1>
			</div>
		</div><!--/.row--><a class="" href="<?=base_url()?>admin/futbol/ekle"><img src="<?=base_url()?>uploads/plus1.png"></a><br>
						  ...
						  <?php
							...
							?>
								  ...
								  <tr>
							              ...
							              <div class="modal-dialog">
							                ...
							                <div class="modal-content">
							                  ...
							                  <div class="modal-body">
												...
												<form action="<?=base_url()?>admin/futbol/resim_upload/<?=$rs->Id?>" method="post" enctype="multipart/form-data">
													Resmi seçiniz:
							        ...
							        <td><a href="<?=base_url()?>admin/futbol/duzenle/<?=$rs->Id?>">Düzenle</a></td>
							        <td><a href="<?=base_url()?>admin/futbol/sil/<?=$rs->Id?>" onclick="return confirm('Silmek istediğinizden emin misiniz?');">Sil</a></td>
							      </tr>
						  <?php
							}
						  ?>
