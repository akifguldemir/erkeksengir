	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				<li><a href="<?=base_url()?>admin/fitness"><svg class="glyph stroked home"><use xlink:href="#stroked-home"></use></svg></a></li>
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Fitness Ekleme Sayfası</h1>
			</div>
		</div><!--/.row--><a class="" href="<?=base_url()?>admin/fitness/ekle"><img src="<?=base_url()?>uploads/plus1.png"></a><br>
		
		<form action="<?=base_url()?>admin/fitness/kaydet" method="POST" >
