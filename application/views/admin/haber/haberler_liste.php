...
?>
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<a class="" href="<?=base_url()?>admin/haberler/ekle"><img src="<?=base_url()?>uploads/plus1.png"></a><br>
							              ...
							              <div class="modal-dialog">
							                ...
							                <div class="modal-content">
							                  ...
							                  <div class="modal-body">
												...
												<form action="<?=base_url()?>admin/haberler/resim_upload/<?=$rs->Id?>" method="post" enctype="multipart/form-data">
													Resmi seçiniz:
