...
<!-- /.modal -->
    ...
    <?php }?>
        ...
        <?php if($profilhakkimda[0]->hakkinda) { ?>
         ...
         <?php } else { ?> 
          <a  href="<?=base_url()?>profil/profilhesapayar" target=blank><font color="black"><p>Hakkınızda bölümünü düzenlemek için tıklayınız.</p></font></a>
         <?php } ?>
        </div>
        <!-- END MENU -->
      </div>
...
<div style="float: left;">
     ...
     <!-- Trigger the modal with a button -->
              ...
              <div class="modal-dialog">
                ...
                <div class="modal-body">
                  <form onsubmit="return validateForm()" id="myForm" action="<?=base_url()?>profil/paylasimkaydet" method="POST" >
              ...
              <div class="modal-dialog">
                ...
                <div class="modal-body">
                  <form onsubmit="return validateForm1()" id="myForm1" action="<?=base_url()?>profil/paylasimkaydetresim" method="post" enctype="multipart/form-data">
                    <?php 
              ...
              <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="tab-content">
                      ...
                      <div class="modal-body">
                        <form onsubmit="return validateForm2()" id="myForm2" action="<?=base_url()?>profil/add_video" method="post" enctype="multipart/form-data">
                          <?php 
                      ...
                      <div class="modal-body">
                          <form onsubmit="return validateForm3()" id="myForm3" action="<?=base_url()?>profil/paylasimkaydetlink" method="POST" >
        ...
        &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
          ...
          ?>
            ...
            <div id="begenmeolayi" style="width: 1145px;">
                    ...
                    <div class="container">
                     ...
                     <div class="sag">
                      <div class="dropdown">
                        ...
                        <font size="2px"><a href="<?=base_url()?>profil/paylasimsil/<?=$rs->Id?>" onclick="return confirm('Silmek İstediğinizden Emin misiniz?');"><i class="glyphicon glyphicon-trash">&nbsp;Sil</i></a></font>
                          


                        <?php if($rs->uye_ID == $this->session->logged_in->Id) { ?>

                          <font size="1px"><a href="<?=base_url()?>profil/paylasimduzenle/<?=$rs->Id?>" ><i class="glyphicon glyphicon-pencil">&nbsp;Düzenle</i></a></font>
                      ...
                      <div class="post-description "> 
                        ...
                        <?php }?>
                         ...
                         <!--<span><a class="btn" href="">Like</a></span>-->
                      </div>
                     <div class="stats">
                        ...
                        <div style="width: 600px;"> 
                         <div class="panel-group">
                          ...
                          <?php if($rs->kime_Id==$rs->uye_ID ) { ?>
                             ...
                             <form onsubmit="return validateFormy<?=$rs->Id?>()" id="myFormy<?=$rs->Id?>" action="<?=base_url()?>profil/paylasimyorumkaydet2/<?=$rs->kime_Id?>" method="post">
                          ...
                          <?php } else { ?> 
                              ...
                              <form onsubmit="return validateFormy1<?=$rs->Id?>()" id="myFormy1<?=$rs->Id?>" action="<?=base_url()?>profil/paylasimyorumkaydet4/<?=$rs->uye_ID?>" method="post">
                                <input type="hidden" name="paylasimId" value="<?=$rs->Id?>">
                                <div style="width: 570px;"> <input class="form-control"  id="enter" name="yorum" placeholder="Yorum yap.." type="text"></div>
                                   <input type="hidden" id="btnSearch" value="Search" onclick="doSomething();" />
                                </span></p>
                                    ...
                                    <li class="comment">
                                      ...
                                      <div class="comment-body">
                                        <div class="comment-heading">
                                          ...
                                          <div class="sss">
                                          <a href="<?=base_url()?>profil/paylasimyorumsil2/<?=$row->Id?>" onclick="return confirm('Yorumu silmek istediğinizden emin misiniz?');" class="paylasimyorumsil"><p><i class="glyphicon glyphicon-trash"></i></p></a>
                                         </div>
                                        </div>
                                        <p><?=$row->yorum?></p>
                                      </div> 
