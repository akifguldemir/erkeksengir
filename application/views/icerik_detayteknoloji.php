							...
							<!-- Section -->
									...
									<section>
										<?php
												...
												foreach((array)$veriteknolojiyorum as $rs)
												{
								...
								<div class="col-sm-12">
									<div class="panel panel-white post panel-shadow">
										...
										<div class="post-description"> 
											...
											<a href="<?=base_url()?>home/teknolojiyorumsil/<?=$rs->Id?>/<?=$veri[0]->Id?>" onclick="return confirm('Silmek İstediğinizden Emin misiniz?');"><p><i class="glyphicon glyphicon-trash"></i></p></a>
											<?php } ?>
									...
									?>
										<h2>Yorum yaz</h2>
											<div id="respond">
											<form onsubmit="return validateForm()" id="myForm" action="<?=base_url()?>home/teknolojiyorumkaydet/<?=$veri[0]->Id?>" method="POST" >
