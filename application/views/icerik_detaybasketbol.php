              ...
              <!-- Section -->
                  ...
                  <section>
                    <?php
                        ...
                        foreach((array)$basketbolyorum as $rs)
                        {
                ...
                <div class="col-sm-12">
                  <div class="panel panel-white post panel-shadow">
                    ...
                    <div class="post-description"> 
                      ...
                      <a href="<?=base_url()?>home/basketbolyorumsil/<?=$rs->Id?>/<?=$veri[0]->Id?>" onclick="return confirm('Silmek İstediğinizden Emin misiniz?');"><p><i class="glyphicon glyphicon-trash"></p></i></a>
                      <?php } ?>
                  ...
                  ?>
                    <h2>Yorum yaz</h2>
                      <div id="respond">
                      <form onsubmit="return validateForm()" id="myForm" action="<?=base_url()?>home/basketbolyorumkaydet/<?=$veri[0]->Id?>" method="POST" >
                 ...
                 <?php
                  ...
                  ?>
                    <font color="#F46969" size="5">Yorum yapmak için lütfen giriş yapınız !</font>
                  <?php } ?>
