								...
								<section>
									...
									<div class="posts">
										...
										<article><font color="#F56A6A"><p><?=$rs->tarih?></p></font>
											...
											<p><?=$rs->aciklama?></p>
											<ul class="actions">
												<li><a href="<?=base_url()?>home/icerikdetayteknoloji/<?=$rs->Id?>" class="button">Daha fazla</a></li>
											</ul>
										</article>
					...
					<div id="sidebar">
						<div class="inner">
							...
							<!-- Section -->
								<section>
									<header class="major">
										<img src="<?=base_url()?>uploads/sondakika.png" width="300" height="auto" alt=""  /></a>
									</header>
